...
def main():
    ...
    if is_master(args, local=args.log_local):
        log_base_path = "./src-stage1/laion_clap/logging/" + args.name
    ...
    text_freeze_parameters = [
        ...
        if 'text_branch' in n and not ('block.20' in n or 'block.21' in n or 'block.22' in n or 'block.23' in n)
    ]

    audio_freeze_parameters = [
        p
        for n, p in named_parameters
        if 'audio_branch' in n and not 'layers.3' in n
    ]
