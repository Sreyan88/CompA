...
class CsvDataset(Dataset):
    def __init__(self, input_filename, img_key, caption_key, sep="\t", is_train = True):
        ...
        self.num_of_positive =  df["num_of_pos"].tolist()
        self.num_of_negatives = df["num_of_neg"].tolist()
    ...
    def __getitem__(self, idx):
        ...
        num_of_pos = self.num_of_positive[idx]
        num_of_neg = self.num_of_negatives[idx]
